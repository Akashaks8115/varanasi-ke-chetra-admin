...
const PanchkroshiForm = () => {
    ...
    return (
        <div className="panchkroshi-form-container">
            ...
            <form onSubmit={handleSubmit} className="modern-form">
                    ...
                    <div className="form-left">
                        <div className="section">
                            ...
                            <div className="form-group">
                                ...
                                <input
                                    ...
                                    placeholder="Enter place name (e.g. Kardameshwar Mahadev)"
                                    required
                                />
                            </div>
                            <div className="form-group">
                        ...
                        <div className="section">
                            ...
                            <div className="form-group">
                                ...
                                <textarea name="Description1" value={formData.Description1} onChange={handleInputChange} placeholder="Primary description" rows={3} />
                            </div>
                            <div className="form-group">
                                <label>Description 2</label>
                                <textarea name="Description2" value={formData.Description2} onChange={handleInputChange} placeholder="Secondary description" rows={3} />
                            </div>
                            <div className="form-group">
                                <label>Description 3</label>
                                <textarea name="Description3" value={formData.Description3} onChange={handleInputChange} placeholder="Additional details" rows={3} />
                            </div>
                        </div>
                    </div>
                    ...
                    <div className="form-right">
                                        ...
                                        >
                                            {previews[field] ? (
                                                <div className="preview-container">
                                                    ...
                                                    <button type="button" className="remove-img" onClick={(e) => { e.stopPropagation(); removeImage(field); }}>
                                                        <X size={14} />
                                                    </button>
                                                </div>
                                            ) : (
                                            ...
                                            <input type="file" hidden ref={fileInputRefs[field as keyof typeof fileInputRefs]} accept="image/*" onChange={(e) => handleFileChange(e, field)} />
                                        </div>
                                    </div>
                                ))}
                            </div>
                        ...
                        <div className="section">
                            ...
                            <div className="form-group">
                                ...
                                <input type="text" name="Location" value={formData.Location} onChange={handleInputChange} placeholder="e.g. Kardameshwar, Varanasi" />
                            </div>
                            <div className="form-group">
                ...
                <div className="form-footer">
                    ...
                    <button type="submit" className="submit-btn">Save Place</button>
                </div>
            </form>
        </div>
    );
...
export default PanchkroshiForm;
